            ...
            <Container fluid>
                <Row>
                    <Col md={4} className='px-5' >
                        <h3 className='mt-5 text-center'>Patient Register</h3>
                        ...
                        <div className='d-flex justify-content-between'>
                            <p className="forgot-password text-right mt-2">
                                <Link component={''} to="/patient-login" style={{ textDecoration: 'none', marginLeft: '5px' }}>Already Have Account? Login</Link>
                            </p>
                        </div>
